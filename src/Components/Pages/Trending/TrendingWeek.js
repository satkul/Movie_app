...
// const fetch_data = await fetch(`https://api.themoviedb.org/3/trending/movie/week?api_key=${KEY}&language=en-US&page=${page}`)
const TrendingWeek = () => {
    const fetchData = async (page) => {
        const { data } = await axios.get(`https://api.themoviedb.org/3/trending/movie/week?api_key=${KEY}&language=en-US&page=${page}`)
